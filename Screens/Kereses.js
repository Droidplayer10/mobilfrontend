...
export default class Kereses extends React.Component {
...
{/*-----------------------------------------------------------Keresés  */}
        ...
        <Text style={{marginTop:50, marginLeft:49,marginRight:20,fontWeight:"bold"}}>Add meg a keresendő szót:</Text>
        <TextInput
